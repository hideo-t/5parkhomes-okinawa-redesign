...
- **SEO 対応**: `SEO_REPORT.md` に監査結果をまとめ、タイトル/ディスクリプション/OG/alt/見出し/JSON-LD/パンくずを最適化。
- **コンテンツグルーピング**: `content/pairs.json` に元サイトのテキスト×画像ペア（63件）を保持し、会社/製品/サービス/事例/FAQ/問い合わせの6カテゴリでレンダリング。
